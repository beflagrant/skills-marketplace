...
**Pointing to fixes**: When you recommend improvements, ground them in the rubric's own dimensions — name the dimension, quote what's missing or vague, and show what a higher-scoring version would look like. The author can then act on each suggestion without bouncing to a separate authoring guide.
